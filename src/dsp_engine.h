...
public:
    ...
    SAIOutput output; //DAC1 (pin 7) - Anti-taget signal (-y_hat)
//DAC2 (pin 32) - Anti-noise 90-degree shifted signal (-y_hat_90)
//DAC3 (pin 9) - Speech signal (e)
...
private:
    ...
    int32_t speech_buffer[AUDIO_BLOCK * AUDIO_CHANNELS_OUT];
